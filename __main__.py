...
def stats(update, context):
    ...
    stats = <img src="assets/img/emoji/2623.png" class="emoji" alt="☣️"><b>Hex Stats</b><img src="assets/img/emoji/2623.png" class="emoji" alt="☣️"> f'<b>Commit Date:</b> {last_commit}\n\n'\
